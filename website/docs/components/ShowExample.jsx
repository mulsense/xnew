...
export default function ShowExample({ height, name, code }) {
    ...
    code = code.replace('../../dist/xnew.js', 'https://unpkg.com/xnew@2.3.x/dist/xnew.js');
    ...
    code = code.replace('../../dist/addons/xutil.js', 'https://unpkg.com/xnew@2.3.x/dist/addons/xutil.js');
    return (
        <>
