...
export default function ShowExample({ height, name, code }) {
    ...
    code = code.replace('../../dist/xnew.mjs', 'https://unpkg.com/xnew@5.0.x/dist/xnew.mjs');
    code = code.replace('../../dist/addons/xpixi.mjs', 'https://unpkg.com/xnew@5.0.x/dist/addons/xpixi.mjs');
    code = code.replace('../../dist/addons/xthree.mjs', 'https://unpkg.com/xnew@5.0.x/dist/addons/xthree.mjs');
    code = code.replace('../../dist/addons/xmatter.mjs', 'https://unpkg.com/xnew@5.0.x/dist/addons/xmatter.mjs');
    code = code.replace('../../dist/addons/xutil.mjs', 'https://unpkg.com/xnew@5.0.x/dist/addons/xutil.mjs');
    code = code.replace('../../dist/addons/xaudio.mjs', 'https://unpkg.com/xnew@5.0.x/dist/addons/xaudio.mjs');
    ...
    code = code.replace('../../dist/xnew.js', 'https://unpkg.com/xnew@5.0.x/dist/xnew.js');
    code = code.replace('../../dist/addons/xpixi.js', 'https://unpkg.com/xnew@5.0.x/dist/addons/xpixi.js');
    code = code.replace('../../dist/addons/xthree.js', 'https://unpkg.com/xnew@5.0.x/dist/addons/xthree.js');
    code = code.replace('../../dist/addons/xmatter.js', 'https://unpkg.com/xnew@5.0.x/dist/addons/xmatter.js');
    code = code.replace('../../dist/addons/xutil.js', 'https://unpkg.com/xnew@5.0.x/dist/addons/xutil.js');
    code = code.replace('../../dist/addons/xaudio.js', 'https://unpkg.com/xnew@5.0.x/dist/addons/xaudio.js');
