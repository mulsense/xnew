...
export default function ShowExample({ height, name, code }) {
    ...
    code = code.replace('../../dist/xnew.module.js', 'https://unpkg.com/xnew@3.0.x/dist/xnew.module.js');
    code = code.replace('../../dist/addons/xpixi.module.js', 'https://unpkg.com/xnew@3.0.x/dist/addons/xpixi.module.js');
    code = code.replace('../../dist/addons/xthree.module.js', 'https://unpkg.com/xnew@3.0.x/dist/addons/xthree.module.js');
    code = code.replace('../../dist/addons/xmatter.module.js', 'https://unpkg.com/xnew@3.0.x/dist/addons/xmatter.module.js');
    code = code.replace('../../dist/addons/xutil.module.js', 'https://unpkg.com/xnew@3.0.x/dist/addons/xutil.module.js');
    code = code.replace('../../dist/addons/xaudio.module.js', 'https://unpkg.com/xnew@3.0.x/dist/addons/xaudio.module.js');
