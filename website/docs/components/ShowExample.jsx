...
export default function ShowExample({ height, name, code }) {
    ...
    code = code.replace('../../dist/xnew.js', 'https://unpkg.com/xnew@2.2.x/dist/xnew.js');
    code = code.replace('../../dist/addons/xpixi.js', 'https://unpkg.com/xnew@2.2.x/dist/addons/xpixi.js');
    code = code.replace('../../dist/addons/xthree.js', 'https://unpkg.com/xnew@2.2.x/dist/addons/xthree.js');
    code = code.replace('../../dist/addons/xmatter.js', 'https://unpkg.com/xnew@2.2.x/dist/addons/xmatter.js');
    return (
        <>
