(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.xcontroller = global.xcontroller || {}, global.xnew));
})(this, (function (exports, xnew) { 'use strict';

  function cancelDefaultActions() {
      xnew(window).on('keydown', (event) => {
          event.preventDefault();
      });
      xnew.current?.on('touchstart contextmenu wheel', (event) => {
          event.preventDefault();
      });
  }
  ...
  class Synthesizer {
      ...
      press(frequency, duration = null, wait = 0.0) {
          frequency = isString(frequency) ? Synthesizer.keymap[frequency] : frequency;
  ...
  exports.DPad = DPad;
  exports.audio = audio;
  exports.cancelDefaultActions = cancelDefaultActions;
